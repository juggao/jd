...
/* computes the ISO calendar date from the current Gregorian date */
    struct tm* ptr; 
    time_t lt; 
    int year,month, month1=1, day, day1=1, i;
    unsigned long long daynumber,daynumber0,daynumber1,isoyear,delta;
    struct iso_s ret;
    ...
    daynumber1=gregdaynumber(year,month1,day1);    
